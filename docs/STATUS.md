...
| CI (`.github/workflows/api.yml`), `quality` + `web` jobs | **PASS** — green on both jobs on the first try, [run 31407990708](https://github.com/WillemKlopper87/TTLI_LMS/actions/runs/31407990708) (quality 3m53s, web 57s) |
