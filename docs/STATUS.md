...
| CI (`.github/workflows/api.yml`), `quality` + `web` jobs | **PASS** — green on both jobs on the first try, [run 31394330419](https://github.com/WillemKlopper87/TTLI_LMS/actions/runs/31394330419) (quality 3m37s, web 55s) |
